...
module.exports = webpackMerge(baseConfig, {
  ...
  mode: 'production',
  // externals: ['React', 'ReactDOM', 'ReactRouterDOM', 'mobx', '_', 'antd', 'PubSub', 'moment'],
  externals: {
    'react-dom': 'ReactDOM',
    'react': 'React',
  ...
  module: {
    rules: [
      {
        test: /\.(css|less)$/,
        include: [resolve('../node_modules'), resolve('../src'), resolve('../umd')],
        use: [
  ...
  plugins: [
    ...
    new CleanWebpackPlugin({
      root: __dirname.replace('webpackset', 'dist-web')
    }),
